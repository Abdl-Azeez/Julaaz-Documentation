      ...
      <main className="relative z-10 flex-1 pb-28 lg:pb-16">
        <section className="container mx-auto px-4 lg:px-8 xl:px-12 max-w-5xl py-6 lg:py-10 space-y-8">
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl border border-border/60 bg-gradient-to-br from-primary/10 via-background to-surface shadow-xl"
          >
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_hsl(var(--primary)_/_0.18),_transparent_45%)]" />
            <div className="relative p-6 lg:p-10 space-y-4">
              {badge && (
                <motion.div
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-background/80 backdrop-blur-lg border border-primary/20 shadow-lg text-xs text-primary font-semibold uppercase tracking-[0.25em]"
                >
                  {badge}
                </motion.div>
              )}
